...
const Footer = () => {
  return (
    <div className="flex flex-wrap w-full h-40 bg-slate-800 text-white justify-between px-8 py-10 mt-5">
      ...
      <ul className="flex flex-col gap-2">
        ...
        <li className="font-bold text-md hover:text-blue-600">Movies</li>
